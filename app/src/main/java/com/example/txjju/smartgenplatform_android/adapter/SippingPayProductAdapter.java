 ...
 * 首页产品列表适配器
 */
public class SippingPayProductAdapter extends RecyclerView.Adapter<SippingPayProductAdapter.ViewHolder> {

    private Context context;
    private List<Purchaseitem> list;
    private SippingPayProductAdapter.ModifyCountInterface modifyCountInterface;

    public SippingPayProductAdapter(Context context , List<Purchaseitem> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_order_sipping_layout, parent, false);
     ...
     */
    public void setModifyCountInterface(SippingPayProductAdapter.ModifyCountInterface modifyCountInterface) {
    ...
    private SippingPayProductAdapter.OnItemClickListener mOnItemClickListener;//声明接口

    public void setOnItemClickListener(SippingPayProductAdapter.OnItemClickListener onItemClickListener) {
