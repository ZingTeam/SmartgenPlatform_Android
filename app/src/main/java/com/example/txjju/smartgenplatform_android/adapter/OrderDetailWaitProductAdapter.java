 ...
 * 首页产品列表适配器
 */
public class OrderDetailWaitProductAdapter extends RecyclerView.Adapter<OrderDetailWaitProductAdapter.ViewHolder> {

    private Context context;
    private List<Purchaseitem> list;

    public OrderDetailWaitProductAdapter(Context context , List<Purchaseitem> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.tvItemTotal.setText((list.get(position).getPurchaseitemPrice()+""));
        holder.tvProductBuyCount.setText(list.get(position).getPurchaseitemCount()+"");
        // 图片加载
